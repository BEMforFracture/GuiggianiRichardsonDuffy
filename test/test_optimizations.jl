"""
Test des optimisations intégrées dans GuiggianiRichardsonDuffy
Compare les 4 méthodes avec la référence Inti
"""
...
println("="^70)
println("TEST: Optimisations intégrées dans GuiggianiRichardsonDuffy")
println("="^70)
